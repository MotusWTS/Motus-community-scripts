...
knitr::kable(df.alltags[1:5, ], caption = "Detection data")
...
knitr::kable(det.data.for.eh[1:5, ])
...
```{r show_data3, echo=FALSE}

knitr::kable(enc.hist[1:5, ], caption = "Encounter histories")
...
```{r show_data4, echo=FALSE}

knitr::kable(det.data.for.ms.eh[1:5, ])
...
```{r show_data5, echo=FALSE}

knitr::kable(ms.enc.hist[1:5, ], caption = "Multi-state encounter histories")
