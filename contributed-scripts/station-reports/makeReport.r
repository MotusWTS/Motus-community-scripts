...
# Run the function
makeReport(
            receiver.name = 'Lawrencetown', # The name you want to have displayed on the report
            receiver.deploy.name = 'Lawrencetown', # A character string that is common among all deployment names
            projectID = 2, # If NA, will look for matching receiver.deploy.names in all deployments
            printable = F, # Removes hyperlinks, etc.
            data.dir = 'E:/Data/', # Where the Motus data will be stored
            save.dir = 'E:/Data/Reports/' # Where the reports will be stored
           )
